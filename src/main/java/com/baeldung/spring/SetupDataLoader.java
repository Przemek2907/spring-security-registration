...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> managerPrivileges = new ArrayList<>(Arrays.asList(writePrivilege, passwordPrivilege));
        ...
        createUserIfNotFound("manager@test.com", "Bruce", "Wayne", "batman", new ArrayList<>(Arrays.asList(managerRole)));
